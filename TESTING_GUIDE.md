...
**หมายเหตุ:** คู่มือนี้สร้างขึ้นเพื่ออธิบายระบบการทดสอบของโปรเจค AI Doc Frontend อย่างละเอียด สามารถใช้เป็น reference เมื่อเขียน test ใหม่หรือแก้ไข test ที่มีอยู่
